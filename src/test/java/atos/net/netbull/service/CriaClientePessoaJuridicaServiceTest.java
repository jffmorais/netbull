...
class CriaClientePessoaJuridicaServiceTest {

	private Validator validator;
	private CriaClientePessoaJuridicaService criaClienteServ;
	...
	public void  iniciarCadaTeste() {	
		this.criaClienteServ = new CriaClientePessoaJuridicaService(validator);
	}
	@Test
	@DisplayName("Testa quando o cliente PJ é nulo.")
	...
	@Test
	@DisplayName("Testa os campos do cliente PJ com obrigatoriedade.")
